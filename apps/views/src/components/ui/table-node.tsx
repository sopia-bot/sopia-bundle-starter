...
export const TableElement = withHOC(
  TableProvider,
  React.memo(function TableElement({
    children,
    ...props
    ...
    const tableClassName = React.useMemo(() => cn(
...
export const TableRowElement = React.memo(function TableRowElement({
  children,
  ...props
...
export const TableCellElement = React.memo(function TableCellElement({
  isHeader,
  ...props
  ...
  ), [element.background, isHeader, selected, borders]);
  ...
  const cellStyle = React.useMemo(() => ({
    ...
    maxWidth: width || 240,
    minWidth: width || 120,
  } as React.CSSProperties), [element.background, width]);

  // 어트리뷰트 메모이제이션
  const cellAttributes = React.useMemo(() => ({
    ...props.attributes,
    colSpan: api.table.getColSpan(element),
    rowSpan: api.table.getRowSpan(element),
  }), [props.attributes, api.table, element]);
